...
namespace Domain.Migrations
{
    ...
    [Migration("20231001200238_RemoveExtraSheetId")]
    partial class RemoveExtraSheetId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Contracts.Database.CellDependency", b =>
                {
                    ...
                    b.HasKey("SheetId", "DependedCellId", "DependedByCellId");

                    b.HasIndex("SheetId", "DependedByCellId");
            ...
            modelBuilder.Entity("Contracts.Database.CellDependency", b =>
                {
                    b.HasOne("Contracts.Database.Cell", "DependedByCell")
                        ...
                        .HasForeignKey("SheetId", "DependedByCellId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Contracts.Database.Cell", "DependedCell")
                        .WithMany("DependByCells")
                        .HasForeignKey("SheetId", "DependedCellId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
