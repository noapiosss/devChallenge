...
namespace E2E.Tests
{
    public class FunctionsTest : BaseTest
    {
        ...
        [Theory]
        [ClassData(typeof(ValidFunctions))]
        public async void ShouldEvaluateFunctions(params CellDataWithStatusCode[] cells)
        {
            // Arrange
        ...
        [Theory]
        [ClassData(typeof(ValidNestedFunctions))]
        public async void ShouldEvaluateNestedFunctions(params CellDataWithStatusCode[] cells)
        {
            // Arrange
            string sheetId = $"sheet{_random.Next(1000000, 9999999)}";
